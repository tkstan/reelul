      ...
      <section id="accueil" className="relative min-h-[92vh] overflow-hidden border-b border-line bg-ink text-paper">
        ...
        <Container className="relative z-10 flex min-h-[92vh] flex-col justify-between py-10 md:py-16">
          ...
          <div className="space-y-6 pb-10 md:pb-16">
            <Label className="text-accent">Écosystème entrepreneurial UL</Label>
        ...
        <Container>
          ...
          <div className="mt-6 grid gap-8 lg:grid-cols-[1.2fr_0.8fr] lg:items-end">
            ...
            <MediaPlaceholder
              ...
              className="h-72 rounded-2xl border-paper/20 bg-[linear-gradient(160deg,#253a68_0%,#182745_100%)] text-paper/70"
            />
          </div>
          <div className="mt-8">
      ...
      <section id="heritage" className="bg-[#090f1e] py-16 md:py-24">
        <Container>
          <div className="grid gap-8 rounded-3xl border border-line bg-[#0e1628] p-8 shadow-soft lg:grid-cols-[1fr_0.9fr] lg:items-center">
            ...
            <MediaPlaceholder label="Plateforme Héritage Entrepreneuriat" className="h-80 rounded-2xl" />
          </div>
        </Container>
      </section>
