...
export function Footer() {
  return (
    <footer className="border-t border-line bg-[#050911]">
      <Container className="flex flex-col gap-6 py-10 text-xs uppercase tracking-[0.12em] text-paper/60 md:flex-row md:items-center md:justify-between">
