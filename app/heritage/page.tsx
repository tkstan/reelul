...
export default function HeritagePage() {
  return (
    ...
    >
      <Card className="grid gap-8 p-8 lg:grid-cols-[1fr_0.9fr] lg:items-center">
        <div className="space-y-4">
          <h3 className="font-display text-5xl uppercase leading-[0.92] text-ink">Heritage Entrepreneuriat</h3>
